...
public class BeanUtils
{
 private BeanUtils(){
        ...
        throws IntrospectionException
    {
        ...
        /**********************************
         * CAST-Finding START #1 (2024-02-02 12:31:11.447355):
        ...
        // QECI Fix: Reverse loop with comparison-to-0 (and break after if condition met)
        for (int i = propertyDescriptors.length - 1; i >= 0; i--) {
            ...
            if (currentPropertyDescriptor.getName().equals(propertyname)) {
                ...
                break; // Once the property is found, exit the loop
            }
        }
/*
