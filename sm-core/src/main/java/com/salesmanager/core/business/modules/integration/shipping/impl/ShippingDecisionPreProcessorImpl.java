...
public class ShippingDecisionPreProcessorImpl implements ShippingQuotePrePostProcessModule {
    ...
    public void prePostProcessShippingQuotes(
         ...
         * Moved the instantiation of the ArrayList<Double> sizeList outside of the loop and clear it at the beginning of each iteration.
         */
        ...
        /* QECI-fix (2024-01-09 19:06:55.798727):
         * Avoid instantiations inside loops: Algorithmic Costs
         * Consider reusing the DecisionResponse object if possible, rather than creating a new one for each method call.
         * Note: This change assumes that the DecisionResponse object can be reused and is not stateful between calls.
         * If DecisionResponse is stateful, this change should not be applied.
         */
